...
from ansible_collections.trendmicro.deepsec.plugins.modules import (
    syslog_config,
)
...
class TestSyslogConfig(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch(
            "ansible_collections.trendmicro.deepsec.plugins.modules._checkpoint_access_rule.Connection"
        )
